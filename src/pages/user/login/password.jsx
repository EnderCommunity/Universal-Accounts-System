...
export default function Password(props){
    ...
    return <>
        ...
        <FlexContainer space={"around"} style={{width: "450px"}}>
            ...
            <Input id={"password"} type={"password"} label={"Password"}
                    ...
                    onActive={function(){document.getElementById("password").type = "text"}}
                    onInactive={function(){document.getElementById("password").type = "password"}}
                    />} style={{width: "100%"}}/>
