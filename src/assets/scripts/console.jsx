...
export const isDevMode = (import.meta.env.MODE == "development" || location.hash == "#activate-developer-mode");
            ...
            dDevTool = (allow, noConsoleLog = false) => {
                if(!userWarned){
                    if(!noConsoleLog){
                        ...
                        console.log('%cYour account, data and privacy will be compromised should you allow other people to access your console or paste code/text into it!', 'font-size: 18px;');
                    }
